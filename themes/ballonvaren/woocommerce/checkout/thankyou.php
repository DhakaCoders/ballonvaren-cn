...
<div class="checkout-sec">
    <div class="checkout-cntrl">
      <div class="checkout-hdr">
        ...
        <h3 class="fl-h3 chkout-title"><?php esc_html_e( 'Bedankt', 'woocommerce' ); ?> <span><?php echo $order->get_billing_first_name(); ?></span>.<br><?php esc_html_e( 'Je bent klaar om te vliegen!', 'woocommerce' ); ?></h3>
