      ...
      <div class="col-md-12">
        <div class="page-404-dsc-wrp">
          ...
          <div class="page-404-btn clearfix">
            <a class="fl-blue-btn" href="<?php echo esc_url(home_url()); ?>"><?php esc_html_e( 'HOME', 'ballonvaren'  ); ?></a>
            <a class="fl-trnsprnt-btn" href="<?php echo get_permalink(get_option( 'woocommerce_shop_page_id' )); ?>"><?php esc_html_e( 'SHOP', 'ballonvaren'  ); ?></a>
          </div>
        </div>
      </div>
    </div>
